        ...
        with torch.no_grad():
            ...
            for i in range(S):
                for j in range(S):
                    ...
                    mse_confidence_score += torch.pow(bbox_true[:,i,j,-1] - bbox_pred[:,i,j,-1] * iou,  2)
